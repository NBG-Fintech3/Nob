...
var TabsPage = /** @class */ (function () {
    function TabsPage(navCtrl) {
        ...
        this.overviewRoot = 'OverviewPage';
        this.scheduleRoot = 'SchedulePage';
        this.paymentsRoot = 'PaymentsPage';
    }
    TabsPage = __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WatsonProvider; });
...
var WatsonProvider = /** @class */ (function () {
    function WatsonProvider(http) {
        this.http = http;
    ...
    WatsonProvider.prototype.callWatson = function (message) {
        console.log(message);
        var params = new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["d" /* HttpParams */]().set('message', message);
        this.http.get('http://127.0.0.1:3000', { headers: this.headers, params: params })
            .subscribe(function (res) { return console.log(res); });
    };
    WatsonProvider = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_watson_watson__ = __webpack_require__(199);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__providers_watson_watson__["a" /* WatsonProvider */],
                __WEBPACK_IMPORTED_MODULE_7__providers_watson_watson__["a" /* WatsonProvider */]
            ]
        })
    ], AppModule);
