...
var OverviewPage = /** @class */ (function () {
    ...
    OverviewPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-overview',template:/*ion-inline-start:"/Users/danae/Nob/src/pages/overview/overview.html"*/'<ion-header>\n    <ion-navbar class="navbar">\n        <ion-grid>\n            <ion-row>\n              <ion-col col-10>\n                  <p class="subheader">Your virtual accountant</p>\n                  <h2 class="header">Here to help you</h2>\n              </ion-col>\n              <ion-col col-2 class="profile"><ion-icon name="person"></ion-icon></ion-col>\n            </ion-row>\n          </ion-grid>\n    </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/danae/Nob/src/pages/overview/overview.html"*/,
        }),
