...
var isDate = __webpack_require__(288)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_operators_map__ = __webpack_require__(198);
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.getMessageList = function () {
        var messageListUrl = './assets/mock/msg-list.json';
    ...
    ChatService.prototype.getToUserInfo = function () {
        var userInfo = {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_watson_watson__ = __webpack_require__(199);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatPage = /** @class */ (function () {
    // create users
    function ChatPage(navParams, chatService, events, watson) {
        var _this = this;
    ...
    // Watson 
    ChatPage.prototype.callWatson = function () {
    ...
    ChatPage.prototype.ionViewDidEnter = function () {
        ...
        this.events.subscribe('chat:received', function (message) {
     ...
     * @param message
     */
    ChatPage.prototype.pushNewMessage = function (message) {
    ...
    ChatPage.prototype.getMessageIndexById = function (id) {
        return this.messages.findIndex(function (e) { return e.messageId === id; });
    };
...
var differenceInSeconds = __webpack_require__(289)
var differenceInMonths = __webpack_require__(291)
var enLocale = __webpack_require__(294)
...
var differenceInMilliseconds = __webpack_require__(290)
...
var parse = __webpack_require__(280)
var differenceInCalendarMonths = __webpack_require__(292)
var compareAsc = __webpack_require__(293)
...
var buildFormattingTokensRegExp = __webpack_require__(297)
